...
class JigsawCausalNeutralDataModule(BaseDataModule):
    def __init__(self, file_path, classification_word="toxic", val_split=0.2):
    ...
    def get_class_names(self):
        return ["non-toxic", self.classification_word]

# Example usage
if __name__ == "__main__":
    file_path = "outputs/jigsaw_toxicity/toxicity_train_toxic_analysis.json"
    classification_word = "toxic"

    data_module = JigsawCausalNeutralDataModule(file_path, classification_word)
