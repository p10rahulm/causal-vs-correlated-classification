...
def run_regularized_imdb_experiment():
    ...
    with open(results_file, 'w', newline='') as csvfile:
        fieldnames = ['model', 'original_epochs', 'regularized_epochs', 'final_loss', 'test_loss', 'test_accuracy',
        ...
        for model_name in models:
            for original_epochs in epochs:
                try:
                    logging.info(f"Running experiment: {model_name}, original_epochs={original_epochs}")
                    ...
                    logging.info(f"Training regularized {model_name} for {num_epochs} epochs...")
                    ...
                    logging.info(
                        f"Completed {model_name}, original_epochs={original_epochs}, regularized_epochs={num_epochs}")
