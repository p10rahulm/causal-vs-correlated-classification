...
class CausalOnlyIMDBDataset(Dataset):
    """
...
class CausalOnlyIMDBDataModule:
    def __init__(self,
    ...
    def load_data(self):
        ...
        full_dataset = CausalOnlyIMDBDataset(self.train_json)
        ...
        self.test_dataset = CausalOnlyIMDBDataset(self.test_json)
