...
def main():
    ...
    output_file = f'outputs/ood-data/imdb_ood_{classification_word.lower()}_analysis.json'
    ...
    print(f"Processed {num_examples} training texts "
        f"and saved results to imdb_ood_{classification_word.lower()}_analysis.json")
